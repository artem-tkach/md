...
public class OrderRecord extends UpdatableRecordImpl<OrderRecord> implements Record7<Long, Long, Long, String, String, Long, LocalDateTime> {
    ...
    @Override
    public Row7<Long, Long, Long, String, String, Long, LocalDateTime> valuesRow() {
    ...
    @Override
    public OrderRecord values(Long value1, Long value2, Long value3, String value4, String value5, Long value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrderRecord(Long id, Long clientId, Long modelId, String serialNumber, String defect, Long managerId, LocalDateTime date) {
        super(Order.ORDER);
