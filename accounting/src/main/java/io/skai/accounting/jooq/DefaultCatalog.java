...
public class DefaultCatalog extends CatalogImpl {
    ...
    /**
     * The schema <code>mobile_accounting</code>.
     */
    public final MobileAccounting MOBILE_ACCOUNTING = MobileAccounting.MOBILE_ACCOUNTING;
    ...
    public final List<Schema> getSchemas() {
        return Arrays.asList(
            MobileAccounting.MOBILE_ACCOUNTING
        );
    }
