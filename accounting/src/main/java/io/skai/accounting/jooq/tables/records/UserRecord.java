...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record6<Long, String, String, String, String, Integer> {
    ...
    @Override
    public UserRecord values(Long value1, String value2, String value3, String value4, String value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(Long id, String name, String email, String phone, String password, Integer role) {
        super(User.USER);
