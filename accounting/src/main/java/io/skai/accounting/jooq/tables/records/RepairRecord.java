...
public class RepairRecord extends UpdatableRecordImpl<RepairRecord> implements Record8<Long, LocalDateTime, Long, Long, String, Double, String, String> {
    ...
    @Override
    public Row8<Long, LocalDateTime, Long, Long, String, Double, String, String> valuesRow() {
    ...
    @Override
    public RepairRecord value8(String value) {
        setGuid(value);
        return this;
    }

    @Override
    public RepairRecord values(Long value1, LocalDateTime value2, Long value3, Long value4, String value5, Double value6, String value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RepairRecord(Long id, LocalDateTime date, Long orderId, Long masterId, String result, Double sum, String comment, String guid) {
        super(Repair.REPAIR);
