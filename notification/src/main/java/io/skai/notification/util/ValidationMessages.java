...
public class ValidationMessages {
    ...
    public static final String NULL_ORDER_STATUS = "Order status can't be null";
    public static final String BLANK_TEMPLATE_BODY = "Body text must have at least one character";
    public static final String BLANK_SUBJECT = "Subject text must have at least one character";
}